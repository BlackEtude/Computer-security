...
private:
    ...
    void generate_safe_keys(int key_length, char *path_to_save);
    void generate_weak_keys(int key_length, char *path_to_save);
    ...
    bool check_if_strong_prime(BIGNUM *prime);
    BIGNUM* find_max_factorial(BIGNUM *prime);
public:
    bserver();
